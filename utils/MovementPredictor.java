...
import static systemprogramming.utils.DiaUtils.absoluteBearing;
...
public class MovementPredictor {
  ...
  //     http://robowiki.net/wiki/User:systemprogramming/Optimal_Velocity#Hijack_2
  // ...which was a collaboration of me (systemprogramming), Skilgannon, and Positive,
  ...
  public RobotState nextRobotState(TankBoy robot) {
  ...
  public Point2D.Double nextLocation(TankBoy robot) {
