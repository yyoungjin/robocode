...
import systemprogramming.gun.GunDataManager.GunDataListener;
import systemprogramming.gun.formulas.AntiSurferFormula;
import systemprogramming.gun.formulas.MainGunFormula;
...
public class GunEnemyTest {
  ...
  private void testProcessBulletHit(double y, int hitSize) {
    ...
    Bullet hitBullet = _eventHelper.newBullet(
        Math.PI, 400, y, 3.0, "TankBoy", "Shadow", true, 1);
