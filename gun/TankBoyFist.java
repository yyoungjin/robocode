...
import systemprogramming.gfx.ColoredValueSet;
import systemprogramming.gfx.RoboGraphic;
import systemprogramming.gfx.RoboPainter;
...
public class TankBoyFist implements RoboPainter {
  ...
  public TankBoyFist(TankBoy robot, boolean isTcMode) {
    this(robot, isTcMode,
  ...
  TankBoyFist(TankBoy robot, boolean isTcMode, BattleField battleField,
  ...
  TankBoyFist(TankBoy robot, boolean isTcMode, GunDataManager gunDataManager,
  ...
  public void initRound(TankBoy robot) {
    _robot = robot;
